...
def create_table(session):
    ...
    CREATE TABLE IF NOT EXISTS spark_streams.created_users(
        ...
        last_name TEXT,
        gender TEXT,
        address TEXT,  -- Corrected typo here
        postcode TEXT,
        email TEXT,
        username TEXT,
    ...
    if spark_conn is not None: 
        ...
        if df is not None:
            ...
            if session is not None:
                ...
                print("Failed to create Cassandra session.")
        else:
            print("Failed to connect to Kafka or no data received.")
    else:
        print("Failed to create Spark connection.")
